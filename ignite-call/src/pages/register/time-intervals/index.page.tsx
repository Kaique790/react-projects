...
const defaultIntervals = [
  ...
  { weekDay: 1, enabled: true, startTime: "08:00", endTime: "14:00" },
...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .refine(
      ...
      {
        message:
          "O horário de fim deve ser pelo menos 1h distante do horário de inicio",
      }
    ),
});
...
export default function TimeIntervals() {
  ...
  return (
    <>
      <NextSeo title="Defina seus horários" noindex />
      <Container>
        <Header>
